...
# create luaScript.zip
#`mv "$APP_ANDROID_ROOT"/assets/luaScript luaScript`
#filelist=`find luaScript -name "*.lua"`
#echo "生成luac"
#for file in $filelist; do `luac -o $file $file`;echo "生成$file"; done;
#echo "生存luaScript.zip"
#if [ -f "APP_ANDROID_ROOT/assets/luaScript.zip" ];  then
#    `rm "$APP_ANDROID_ROOT"/assets/luaScript.zip`
#fi
#`zip "$APP_ANDROID_ROOT"/assets/luaScript.zip -r luaScript`
#`rm -rf luaScript`
